...
class SourceManager(private val context: Context) {
    ...
    fun getSources(): List<RomSource> {
        ...
        // Archive.org and itch.io are always available as built-in sources
        return listOf(RomSource.archiveOrg(), RomSource.itchIo()) + customSources
    }
...
data class RomSource(
    ...
    companion object {
        ...
        fun itchIo() = RomSource(
            id = "itch_io",
            type = SourceType.ITCH_IO,
            name = "itch.io",
            path = "https://itch.io"
        )
