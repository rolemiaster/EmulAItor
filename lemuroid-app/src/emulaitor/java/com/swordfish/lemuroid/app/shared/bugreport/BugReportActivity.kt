...
class BugReportActivity : ComponentActivity() {
    ...
    private fun loadBugReportForm() {
        ...
        // Incluye tanto el versionName como el versionCode (AAB) para depuración precisa
        val fullUrl = "$baseUrl?app=EmulAItor&version=${BuildConfig.VERSION_NAME} (${BuildConfig.VERSION_CODE})"
