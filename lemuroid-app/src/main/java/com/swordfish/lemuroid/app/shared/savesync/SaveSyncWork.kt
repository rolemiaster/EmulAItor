...
class SaveSyncWork(context: Context, workerParams: WorkerParameters) :
    ...
    private suspend fun displayNotification(): Boolean {
        ...
        try {
            ...
            Timber.e(e, "Failed to start Foreground Service for SaveSyncWork")
            return false
        }
    }

    companion object {
        val UNIQUE_WORK_ID: String = SaveSyncWork::class.java.simpleName + "_v2"
        val UNIQUE_PERIODIC_WORK_ID: String = SaveSyncWork::class.java.simpleName + "Periodic_v2"
