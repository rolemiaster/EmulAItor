...
class TVGameMenuActivity : TVBaseSettingsActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        // This menu is recreated from game-session intent extras. Letting FragmentManager
        // restore the previous parameterized Leanback fragments can crash after process death.
        super.onCreate(null)
