...
abstract class LemuroidApplicationModule {
    ...
    @PerActivity
    @ContributesAndroidInjector
    abstract fun paywallActivity(): com.swordfish.lemuroid.app.mobile.feature.paywall.PaywallActivity
    ...
    companion object {
        ...
        fun retrogradeDb(app: LemuroidApplication) =
            Room.databaseBuilder(app, RetrogradeDatabase::class.java, RetrogradeDatabase.DB_NAME)
                ...
                .addMigrations(GameSearchDao.MIGRATION, Migrations.VERSION_8_9, Migrations.VERSION_9_10, Migrations.VERSION_10_11, Migrations.VERSION_11_12)
        ...
        @PerApp
        @JvmStatic
        fun theGamesDBMetadataProvider(settingsManager: SettingsManager): TheGamesDBMetadataProvider {
            ...
            return TheGamesDBMetadataProvider(shortTimeoutClient, settingsManager)
        }
        ...
        fun gameMetadataProvider(
            ...
            theGamesDBMetadataProvider: TheGamesDBMetadataProvider,
        ): GameMetadataProvider {
            return CompositeMetadataProvider(
                systemDetectionProviders = listOf(
                    LibretroDBMetadataProvider(libretroDBManager),
                ),
                enrichmentProviders = listOf(
                    theGamesDBMetadataProvider,
                ),
            )
        }
        ...
        fun postGameHandler(
            retrogradeDatabase: RetrogradeDatabase,
            accessManager: com.swordfish.lemuroid.ext.feature.access.AccessManager
        ) = GameLaunchTaskHandler(ReviewManager(), retrogradeDatabase, accessManager)
        ...
        ) = com.swordfish.lemuroid.app.mobile.feature.catalog.RomDownloader(context, gameMetadataProvider)
        @Provides
        @PerApp
        @JvmStatic
        fun billingManager(context: Context) = com.swordfish.lemuroid.ext.feature.billing.BillingManager(context)
        ...
        fun accessManager(
            context: Context,
            billingManager: com.swordfish.lemuroid.ext.feature.billing.BillingManager
        ) = com.swordfish.lemuroid.ext.feature.access.AccessManager(
            context,
            billingManager,
            com.swordfish.lemuroid.ext.feature.license.LicenseGate()
        )
    }
}
